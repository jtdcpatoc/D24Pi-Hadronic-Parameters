...
int main(int argc, char *argv[]){
    ...
    double mPlusPrime, mMinusPrime, cosThetaPlus, cosThetaMinus, phi, m12, m34;
  ...
  ////////////////////////////////////////////
    ...
    TFile fOut("/home/patoc/work/DPhil1/D0_Mixing_Generator_Studies/for_jairus/D02pipipipi_binning_scheme/ROOT_output/Test_BesEqualV0.root","recreate");
    TTree t1("GenEvents","Test events binned with BesEqualV0");
...
/* 
      std::cout << "D0Amplitude: " << Damp << "\n";
      std::cout << "D0_conj_Amplitude: " << D0_conj_Amplitude << "\n\n";
