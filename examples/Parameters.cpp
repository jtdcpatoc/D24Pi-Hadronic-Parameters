...
int main(int argc, char *argv[]) {
  ...
  double mPlusPrime, mMinusPrime, cosThetaPlus, cosThetaMinus, phi, Damp_Mag, DBARamp_Mag, StrongPhaseDiff, EventWeight, Damp_real, Damp_imag, DBARamp_real, DBARamp_imag;
  ...
  input_tree->SetBranchAddress("mPlusPrime",&mPlusPrime);
  input_tree->SetBranchAddress("mMinusPrime",&mMinusPrime);
  input_tree->SetBranchAddress("cosThetaPlus",&cosThetaPlus);
  input_tree->SetBranchAddress("cosThetaMinus",&cosThetaMinus);
...
//____________________________________________//
  ...
  int NumberBins = 5; //Number of UNIQUE bins
