...
class Event {
  public:
    /**
     * Default constructor for D to pi+ pi- pi+ pi- event with zero momentum
     */
    Event();
    /**
     * Constructor that takes a vector of four-momenta
     * @param p Four-momenta in the form (px, py, pz, E), in the order pi+ pi- pi+ pi-
     */
     ...
     * @return Four-momenta of daughter particles in the form (E, px, py, pz), in the order  pi+ pi- pi+ pi-
     */
    const std::vector<double>& GetEventVector() const;
    /**
     * Constructor that takes a vector of four-momenta
     * @param p Vector of TLorentzVector objects, in the order  pi+ pi- pi+ pi-
     * 
     */
